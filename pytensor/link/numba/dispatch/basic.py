...
def numba_funcify_AdvancedIncSubtensor1(op, node, **kwargs):
    ...
    if set_instead_of_inc:
        advancedincsubtensor1_inplace = advancedincsubtensor1_inplace_set
    else:
        advancedincsubtensor1_inplace = advancedincsubtensor1_inplace_inc
...
def direct_cast(typingctx, val, typ):
    ...
    def codegen(context, builder, signature, args):
        # TODO Check this. Don't we need to generate code
        # for the cast? And do we really need the incref here?
        val, _ = args
